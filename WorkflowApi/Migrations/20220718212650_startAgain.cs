        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Low")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invitations_AspNetUsers_SourceUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppTasks_Priorityies_PriorityId",
                        column: x => x.PriorityId,
                        principalTable: "Priorityies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppTasks_States_StateId",
                        column: x => x.StateId,
                        principalTable: "States",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppTasks_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppTasks_StateId",
                table: "AppTasks",
                column: "StateId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTasks_TeamId",
                table: "AppTasks",
                column: "TeamId");
